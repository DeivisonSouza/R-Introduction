...
+ Quais árvores estão selecionadas para <bdi style="font-weight:bold">explorar</bdi> `e` possuem <bdi style="font-weight:bold">QF igual a 1</bdi>?

```{r operE3, echo=TRUE, eval=FALSE}
dt$Selecao == "Explorar" & dt$QF == 1
```
